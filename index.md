...
humandate: "04.-08.03.2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "vormittags (ab 9 Uhr)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Eva Bunge", "Timo Henne", "Jonas Kaiser", "Péter Király", "David Krassnig", "Julika Mimkes", "Andreas Walker", "Alexander Winkler"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["André M. Pietsch", "Louise Rumpf"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["mimkes@sub.uni-goettingen.de","andreas.walker@awi.de"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
